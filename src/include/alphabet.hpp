...
namespace lb {
    ...
    public:
        ...
        //
        lb::symbol_type operator[](lb::size_t index) const
           { return rmap[index]; }
        ...
        lb::size_t size() const
            { return sz; }
    private:
        //  Array that is indexed with alphabet symbols and stores index value.
        uint8 map[256];
        //  Array that is indexed with index of symbols in the alphabet and stores the symbols.
        lb::symbol_type rmap[256];
